   ...
   // Sidemenu toggle
    ...
    wind.on("scroll",function () {
        ...
        if(bodyScroll > 100){
            ...
            darkbg.attr('src', 'img/choix_02.png');
            whitebg.attr('src', 'img/logo-dark.png');
            scrollbg.attr('src', 'img/choix_02.png');
            lightbg.attr('src', 'img/logo-dark.png');

        }else{
            navbar.removeClass("nav-scroll");
            logo.attr('src', 'img/choix_02.png');
            lightbg.attr('src', 'img/logo-dark.png');
    ...
    $(document).ready(function() {
        ...
        // CountDown for coming soon page
            if ($(".countdown").length !== 0) {
                $(".countdown").countdown({
                    date: "08 Jul 2019 00:08:00", //set your date and time. EX: 15 May 2014 12:00:00
                    format: "on"
                });
            }
